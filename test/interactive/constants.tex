...
\end{align}
%
where, denoting $\mu_g = \mathbb{E}[g]$ and $\mu_h = \mathbb{E}[h]$, the covariance is defined as
%
\begin{align}
...
%
\begin{align}
  \partial_{\gamma} \mathrm{Cov}(g, h) & = \left( \mathbb{E}[(\partial_{\gamma} g) h] - \mathbb{E}[\partial_{\gamma} g] \mathbb{E}[h] \right) + \left( \mathbb{E}[g (\partial_{\gamma} h)] - \mathbb{E}[g] \mathbb{E}[\partial_{\gamma} h] \right) \\
...
\end{align}
%
The term in the parenthesis is the third joint central moment, or third-order covariance, of $(g, h, \partial_{\gamma} \tilde{r})$. Expanding the definition of the third central moment confirms its equivalence to this term:
%
\begin{align}
...
The Jacobian of $\Phi$ contains the Hessian of $\Omega$ in its first three rows and the third-order partial derivatives of $\Omega$ in its last six rows. We derive the third derivatives by differentiating the Hessian of $\Omega$ from \cref{eq:residual-hessian-full} with respect to a parameter $\gamma \in \{x, \nu, \delta\}$:
%
\begin{align}
  \partial_{\gamma}(\nabla_\theta^2 \Omega) = \partial_{\gamma} \mathbb{E}[\nabla_\theta^2 \tilde{r}] - \partial_{\gamma}\mathrm{Cov}(\nabla_\theta \tilde{r}, \nabla_\theta \tilde{r}) + \mathrm{diag}(0,0,-2\delta^{-3}).
\end{align}
%
...
\begin{align}
  ...
  \Rightarrow \partial_{\alpha\beta\gamma} \Omega                                        & = \mathbb{E}[\partial_{\alpha\beta\gamma} \tilde{r}] - \mathrm{Cov}(\partial_{\alpha\beta} \tilde{r}, \partial_{\gamma} \tilde{r}) - \mathrm{Cov}(\partial_{\alpha\gamma} \tilde{r}, \partial_{\beta} \tilde{r}) - \mathrm{Cov}(\partial_{\beta\gamma} \tilde{r}, \partial_{\alpha} \tilde{r}) \\
                                                                                         & + \mathrm{Cov3}(\partial_{\alpha} \tilde{r}, \partial_{\beta} \tilde{r}, \partial_{\gamma} \tilde{r}) - 2\delta^{-3} \mathbf{1}_{\{\alpha=\beta=\gamma=\delta\}}.
\end{align}
%
